        ...
        <div className="row align-items-start">
          ...
          <div className="col-lg-5">
            <div className="brand-section">
              ...
              <p className=" text-light">We are a passionate team dedicated to delivering innovative solutions, quality services, and excellent customer experiences. Our goal is to build trust, create value, and help people grow successfully..</p>
              ...
              <div className="row">
                ...
                <div className="col-md-6 col-12 ">
                  <div className="nav-column">
                    ...
                    <p className='text-light my-3'>Our newsletter service keeps you updated with the latest news, exclusive offers, industry insights, and important announcements. Subscribe to receive valuable content directly in your inbox and stay connected with trends, updates, and opportunities that matter most to you and your business.</p>
                    <div>
                      <form>
                        <div className="btn-group w-100">
                          <input type="email" name="email" placeholder='Enter your Email Address to subscribe our news letter service' className='form-control rounded-0 rounded-start' />
