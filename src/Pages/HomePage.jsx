          ...
          <div className="col-lg-6">
            <div className="hero-content">
              ...
              <h1 data-aos="fade-right" data-aos-delay="300">
               <span className="highlight">Timeless Heritage   </span>  Modern Style  - Discover Quality You can True at heritage Ally
               
              </h1>

              <p className="hero-description" data-aos="fade-right" data-aos-delay="400">
                Delivering trusted healthcare solutions with compassion, innovation, and patient-focused care for healthier communities.
              </p>
          ...
          <div className="col-lg-6">
            <div className="hero-visual" data-aos="fade-left" data-aos-delay="400">
              <div className="main-image">
                <img src="assets/img/banner/b2.jpg" alt="Modern Healthcare Facility" className="img-fluid"/>
