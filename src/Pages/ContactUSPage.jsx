...
export default function ContactUSPage() {
  return (
    <>
    <Breadcrum title="Contact Us" description={"You can contact us via email for general inquiries, support requests, or business opportunities. If you prefer, feel free to call us during our working hours for immediate assistance. We also encourage you to connect with us through our social media platforms to stay updated and engaged."}/>
